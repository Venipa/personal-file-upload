(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["app-dashboard-view"],{
...
/* harmony import */ var vue_material_design_icons_Download__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! vue-material-design-icons/Download */ "./node_modules/vue-material-design-icons/Download.vue");
/* harmony import */ var vue_material_design_icons_Upload__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! vue-material-design-icons/Upload */ "./node_modules/vue-material-design-icons/Upload.vue");
/* harmony import */ var vue_material_design_icons_EyePlus__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! vue-material-design-icons/EyePlus */ "./node_modules/vue-material-design-icons/EyePlus.vue");
...
/* harmony import */ var vue_material_design_icons_Image__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! vue-material-design-icons/Image */ "./node_modules/vue-material-design-icons/Image.vue");
/* harmony import */ var vue_material_design_icons_Video__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! vue-material-design-icons/Video */ "./node_modules/vue-material-design-icons/Video.vue");
/* harmony import */ var vue_material_design_icons_Music__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! vue-material-design-icons/Music */ "./node_modules/vue-material-design-icons/Music.vue");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    ...
    "app-spinner": _saeris_vue_spinners__WEBPACK_IMPORTED_MODULE_4__["PulseLoader"],
    DownloadIcon: vue_material_design_icons_Download__WEBPACK_IMPORTED_MODULE_5__["default"],
    UploadIcon: vue_material_design_icons_Upload__WEBPACK_IMPORTED_MODULE_6__["default"],
    ViewIcon: vue_material_design_icons_EyePlus__WEBPACK_IMPORTED_MODULE_7__["default"],
    LinkIcon: vue_material_design_icons_Link__WEBPACK_IMPORTED_MODULE_8__["default"],
    ImageIcon: vue_material_design_icons_Image__WEBPACK_IMPORTED_MODULE_9__["default"],
    VideoIcon: vue_material_design_icons_Video__WEBPACK_IMPORTED_MODULE_10__["default"],
    AudioIcon: vue_material_design_icons_Music__WEBPACK_IMPORTED_MODULE_11__["default"]
  },
  data: function data() {
    return defaultData();
  },
  ...
  methods: {
    ...
    copySecret: function copySecret(key) {
      this.$clipboard(key);
    ...
    generateNew: function generateNew() {
      ...
      _api__WEBPACK_IMPORTED_MODULE_1__["user"].generateNew().then(function (x) {
        var _x$data, _x$data4;

        if (!((_x$data = x.data) === null || _x$data === void 0 ? void 0 : _x$data.key)) {
          _this.isGenerateLoading = false;
          return;
        }

        if (!_this.user.apikey) {
          var _x$data2;

          _this.user = {
            apikey: (_x$data2 = x.data) === null || _x$data2 === void 0 ? void 0 : _x$data2.key
          };
        } else {
          var _x$data3;

          _this.user.apikey = (_x$data3 = x.data) === null || _x$data3 === void 0 ? void 0 : _x$data3.key;
        }

        _this.isGenerateLoading = false;

        _this.copySecret((_x$data4 = x.data) === null || _x$data4 === void 0 ? void 0 : _x$data4.key);
      })["catch"](function (err) {
        console.error(err);
        _this.isGenerateLoading = false;
      });
  ...
  mounted: function mounted() {
    ...
    _api__WEBPACK_IMPORTED_MODULE_1__["user"].currentUser().then(function (x) {
      var _x$data5;

      _this2.user = (_x$data5 = x.data) === null || _x$data5 === void 0 ? void 0 : _x$data5.user;
    });
    _api__WEBPACK_IMPORTED_MODULE_1__["user"].statistics().then(function (x) {
      _this2.isLoading = false;
      _this2.stats = x.data.statistics;
    }, function (_ref) {
      var error = _ref.error,
          data = _ref.data;

      if (data === null || data === void 0 ? void 0 : data.errors) {
        _this2.setError(_helpers__WEBPACK_IMPORTED_MODULE_2__["ErrorBag"].getFirstError(data.errors));
      } else {
        _this2.setError(_helpers__WEBPACK_IMPORTED_MODULE_2__["ErrorBag"].getResponseErrorString(error));
      }
    });
  }
});
...
var render = function() {
  ...
  return _c("div", { staticClass: "dashboard my-4" }, [
    _c("div", { staticClass: "container" }, [
      ...
      _c("div", { staticClass: "row mb-3" }, [
        _c("div", { staticClass: "col d-flex" }, [
          _c("div", { staticClass: "card flex-fill flex-col" }, [
            _vm.user
              ? _c(
                  "div",
                  { staticClass: "card-body flex-column" },
                  [
                    _c(
                      "b-form-group",
                      {
                    ...
                    _c(
                      ...
                      [
                        _c(
                          "b-button",
                          {
                            staticClass: "d-flex flex-row mr-2",
                            attrs: {
                              variant: "primary",
                              disabled: _vm.isGenerateLoading
                            },
                            on: {
                              click: function($event) {
                                $event.preventDefault()
                                return _vm.generateNew($event)
                              }
                            }
                          },
                          [
                          ...
                          "b-button",
                          {
                            ...
                            on: {
                              click: function($event) {
                                $event.preventDefault()
                                return (function() {
                                  return _vm.copySecret(_vm.user.apikey)
                                })($event)
                              }
                            }
                          },
